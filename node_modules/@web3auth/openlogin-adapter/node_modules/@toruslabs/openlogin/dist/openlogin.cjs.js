...
class OpenLogin {
  ...
  async init() {
    ...
    if (this.state.support3PC) {
      ...
      this._syncState((0,utils/* getHashQueryParams */.Gv)(this.state.replaceUrlOnRedirect));
  ...
  async _fastLogin(params) {
    ...
    const res = await this.request({
      ...
      allowedInteractions: [constants/* ALLOWED_INTERACTIONS.POPUP */.xQ.POPUP, constants/* ALLOWED_INTERACTIONS.REDIRECT */.xQ.REDIRECT]
    });
