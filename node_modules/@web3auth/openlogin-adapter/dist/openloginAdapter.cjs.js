...
class OpenloginAdapter extends base_namespaceObject.BaseAdapter {
  ...
  async init(options) {
    ...
    if (!this.chainConfig && this.currentChainNamespace !== base_namespaceObject.CHAIN_NAMESPACES.OTHER) throw base_namespaceObject.WalletInitializationError.invalidParams("chainConfig is required before initialization");
